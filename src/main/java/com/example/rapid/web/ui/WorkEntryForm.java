 ...
 */
public class WorkEntryForm extends CustomComponent implements EntityEditor {
...
//        }
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        projectField.setWidth("-1px");
        projectField.setHeight("-1px");
        projectField.setCaption("Project");
        projectField.setImmediate(true);
        fieldLayout.addComponent(projectField);

        // employeeField
        employeeField = new ComboBox();
        employeeField.setWidth("-1px");
        employeeField.setHeight("-1px");
        employeeField.setCaption("Employee");
        employeeField.setImmediate(true);
        fieldLayout.addComponent(employeeField);
        ...
        fieldLayout.addComponent(startTimeField);
