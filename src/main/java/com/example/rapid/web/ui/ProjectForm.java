 ...
 */
public class ProjectForm extends CustomComponent implements EntityEditor {
...
//        }
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        enabledField.setWidth("-1px");
        enabledField.setHeight("-1px");
        enabledField.setCaption("Enabled");
        enabledField.setImmediate(true);
        fieldLayout.addComponent(enabledField);
