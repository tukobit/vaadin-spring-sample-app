...
import com.example.rapid.web.ui.RapidUserForm;
...
privileged aspect RapidUserForm_Roo_VaadinVisuallyComposableEntityForm {
    
    private Map<Object, Field> RapidUserForm.fieldMap = new LinkedHashMap<Object, Field>();
    
    private Map<Object, PropertyConverter> RapidUserForm.converterMap = new LinkedHashMap<Object, PropertyConverter>();
    
    public Collection<Object> RapidUserForm.getBeanPropertyIds() {
        return Arrays.asList(new Object[] { "username", "password", "admin" });
    }
    
    public Field RapidUserForm.getField(Object propertyId) {
        return fieldMap.get(propertyId);
    }
    
    public void RapidUserForm.configure() {
        configureFieldMap();
        configureFields();
    ...
    public void RapidUserForm.refresh() {
        configureContainersForFields();
        configureConverters();
        configureValidators();
    }
    
    public boolean RapidUserForm.isModified() {
    ...
    public void RapidUserForm.configureContainersForFields() {
        // no fields require special containers
    }
    
    public void RapidUserForm.configureConverters() {
        // no converters needed
    }
    
    public void RapidUserForm.configureValidators() {
        for (Object propertyId : getBeanPropertyIds()) {
            Field field = getField(propertyId);
            if (field != null) {
    ...
    public PropertyConverter RapidUserForm.getConverter(Object propertyId) {
        return converterMap.get(propertyId);
    }
    
    public String RapidUserForm.getIdProperty() {
        return "id";
    }
    
    public String RapidUserForm.getVersionProperty() {
        return "version";
    }
    
    public void RapidUserForm.validateFields() {
        if (getItemDataSource() != null) {
            for (Object propertyId : getItemDataSource().getItemPropertyIds()) {
                Field field = getField(propertyId);
    ...
    public void RapidUserForm.commitFields() {
        if (getItemDataSource() != null) {
            for (Object propertyId : getItemDataSource().getItemPropertyIds()) {
                Field field = getField(propertyId);
                if (field != null && !field.isReadOnly()) {
    ...
    public void RapidUserForm.setFieldPropertyDataSource(Object propertyId, Property property) {
        Field field = getField(propertyId);
        if (field == null) {
            return;
        }
    ...
    public void RapidUserForm.setFieldValues(Item item) {
        if (item != null) {
    ...
    public Field RapidUserForm.getFirstField() {
    ...
    public Class<RapidUser> RapidUserForm.getEntityClass() {
