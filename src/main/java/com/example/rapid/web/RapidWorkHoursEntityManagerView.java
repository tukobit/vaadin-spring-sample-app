 ...
 */
public class RapidWorkHoursEntityManagerView extends CustomComponent implements ViewChangeListener {
    ...
    private class EntitySidebarItem extends SidebarItem {
        ...
        private final Class<? extends Navigator> viewClass;

        public EntitySidebarItem(final String viewName, Class<? extends Navigator> viewClass) {
            super(viewName);
     ...
     */
    public RapidWorkHoursEntityManagerView() {
        setSizeFull();
