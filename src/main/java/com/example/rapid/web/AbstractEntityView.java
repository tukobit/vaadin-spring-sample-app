...
public abstract class AbstractEntityView<E> extends CustomComponent implements View {
    ...
    public void navigateTo(String requestedDataId) {
        // refresh table
    	System.out.println("Navigate To method called" + requestedDataId);
        refresh();
